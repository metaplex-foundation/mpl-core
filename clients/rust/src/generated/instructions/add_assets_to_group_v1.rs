...
pub struct AddAssetsToGroupV1InstructionData {
    discriminator: u8,
}

impl AddAssetsToGroupV1InstructionData {
    pub fn new() -> Self {
...
#[derive(Default)]
pub struct AddAssetsToGroupV1Builder {
...
impl AddAssetsToGroupV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddAssetsToGroupV1 {
...
/// `add_assets_to_group_v1` CPI accounts.
pub struct AddAssetsToGroupV1CpiAccounts<'a, 'b> {
    /// The address of the group to modify
...
/// `add_assets_to_group_v1` CPI instruction.
pub struct AddAssetsToGroupV1Cpi<'a, 'b> {
...
impl<'a, 'b> AddAssetsToGroupV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddAssetsToGroupV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddAssetsToGroupV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   2. `[signer, optional]` authority
///   3. `[]` system_program
pub struct AddAssetsToGroupV1CpiBuilder<'a, 'b> {
    instruction: Box<AddAssetsToGroupV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddAssetsToGroupV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddAssetsToGroupV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddAssetsToGroupV1Cpi {
...
struct AddAssetsToGroupV1CpiBuilderInstruction<'a, 'b> {
