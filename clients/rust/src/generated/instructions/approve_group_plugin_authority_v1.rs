...
/// Accounts.
pub struct ApproveGroupPluginAuthorityV1 {
...
impl ApproveGroupPluginAuthorityV1 {
    pub fn instruction(
        &self,
        args: ApproveGroupPluginAuthorityV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ApproveGroupPluginAuthorityV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct ApproveGroupPluginAuthorityV1InstructionData {
    discriminator: u8,
}

impl ApproveGroupPluginAuthorityV1InstructionData {
    pub fn new() -> Self {
...
pub struct ApproveGroupPluginAuthorityV1InstructionArgs {
    pub plugin_type: PluginType,
    pub new_authority: PluginAuthority,
}

/// Instruction builder for `ApproveGroupPluginAuthorityV1`.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
#[derive(Default)]
pub struct ApproveGroupPluginAuthorityV1Builder {
...
impl ApproveGroupPluginAuthorityV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the group
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ApproveGroupPluginAuthorityV1 {
        ...
        let args = ApproveGroupPluginAuthorityV1InstructionArgs {
...
/// `approve_group_plugin_authority_v1` CPI accounts.
pub struct ApproveGroupPluginAuthorityV1CpiAccounts<'a, 'b> {
    /// The address of the group
...
/// `approve_group_plugin_authority_v1` CPI instruction.
pub struct ApproveGroupPluginAuthorityV1Cpi<'a, 'b> {
    ...
    pub __args: ApproveGroupPluginAuthorityV1InstructionArgs,
}

impl<'a, 'b> ApproveGroupPluginAuthorityV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ApproveGroupPluginAuthorityV1CpiAccounts<'a, 'b>,
        args: ApproveGroupPluginAuthorityV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ApproveGroupPluginAuthorityV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   3. `[]` system_program
///   4. `[optional]` log_wrapper
pub struct ApproveGroupPluginAuthorityV1CpiBuilder<'a, 'b> {
    instruction: Box<ApproveGroupPluginAuthorityV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ApproveGroupPluginAuthorityV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ApproveGroupPluginAuthorityV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ApproveGroupPluginAuthorityV1Cpi {
...
struct ApproveGroupPluginAuthorityV1CpiBuilderInstruction<'a, 'b> {
