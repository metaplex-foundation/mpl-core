...
impl UpdatePluginV2 {
    pub fn instruction(
        &self,
        args: UpdatePluginV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdatePluginV2InstructionData::new().try_to_vec().unwrap();
...
pub struct UpdatePluginV2InstructionData {
    discriminator: u8,
}

impl UpdatePluginV2InstructionData {
    pub fn new() -> Self {
...
pub struct UpdatePluginV2InstructionArgs {
    pub plugin: Option<Plugin>,
}

/// Instruction builder for `UpdatePluginV2`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   6. `[optional]` buffer_account
#[derive(Default)]
pub struct UpdatePluginV2Builder {
...
impl UpdatePluginV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = UpdatePluginV2InstructionArgs {
...
/// `update_plugin_v2` CPI accounts.
pub struct UpdatePluginV2CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `update_plugin_v2` CPI instruction.
pub struct UpdatePluginV2Cpi<'a, 'b> {
    ...
    pub __args: UpdatePluginV2InstructionArgs,
}

impl<'a, 'b> UpdatePluginV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdatePluginV2CpiAccounts<'a, 'b>,
        args: UpdatePluginV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdatePluginV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   5. `[optional]` log_wrapper
///   6. `[optional]` buffer_account
pub struct UpdatePluginV2CpiBuilder<'a, 'b> {
    instruction: Box<UpdatePluginV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdatePluginV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdatePluginV2CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdatePluginV2Cpi {
...
struct UpdatePluginV2CpiBuilderInstruction<'a, 'b> {
