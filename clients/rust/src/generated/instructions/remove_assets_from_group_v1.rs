...
impl RemoveAssetsFromGroupV1 {
    pub fn instruction(
        &self,
        args: RemoveAssetsFromGroupV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RemoveAssetsFromGroupV1InstructionData::new()).unwrap();
...
pub struct RemoveAssetsFromGroupV1InstructionData {
    discriminator: u8,
}

impl RemoveAssetsFromGroupV1InstructionData {
    pub fn new() -> Self {
...
pub struct RemoveAssetsFromGroupV1InstructionArgs {
    pub assets: Vec<Pubkey>,
}

/// Instruction builder for `RemoveAssetsFromGroupV1`.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
#[derive(Default)]
pub struct RemoveAssetsFromGroupV1Builder {
    group: Option<solana_program::pubkey::Pubkey>,
    payer: Option<solana_program::pubkey::Pubkey>,
    authority: Option<solana_program::pubkey::Pubkey>,
    system_program: Option<solana_program::pubkey::Pubkey>,
    assets: Option<Vec<Pubkey>>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl RemoveAssetsFromGroupV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the group to modify
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RemoveAssetsFromGroupV1 {
...
/// `remove_assets_from_group_v1` CPI accounts.
pub struct RemoveAssetsFromGroupV1CpiAccounts<'a, 'b> {
    /// The address of the group to modify
...
/// `remove_assets_from_group_v1` CPI instruction.
pub struct RemoveAssetsFromGroupV1Cpi<'a, 'b> {
    ...
    pub __args: RemoveAssetsFromGroupV1InstructionArgs,
}

impl<'a, 'b> RemoveAssetsFromGroupV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RemoveAssetsFromGroupV1CpiAccounts<'a, 'b>,
        args: RemoveAssetsFromGroupV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveAssetsFromGroupV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   2. `[signer, optional]` authority
///   3. `[]` system_program
pub struct RemoveAssetsFromGroupV1CpiBuilder<'a, 'b> {
    instruction: Box<RemoveAssetsFromGroupV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveAssetsFromGroupV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveAssetsFromGroupV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
...
struct RemoveAssetsFromGroupV1CpiBuilderInstruction<'a, 'b> {
