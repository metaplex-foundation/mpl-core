...
impl AddCollectionsToGroupV1 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = borsh::to_vec(&AddCollectionsToGroupV1InstructionData::new()).unwrap();
...
pub struct AddCollectionsToGroupV1InstructionData {
    discriminator: u8,
}

impl AddCollectionsToGroupV1InstructionData {
    pub fn new() -> Self {
...
#[derive(Default)]
pub struct AddCollectionsToGroupV1Builder {
...
impl AddCollectionsToGroupV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddCollectionsToGroupV1 {
...
/// `add_collections_to_group_v1` CPI instruction.
pub struct AddCollectionsToGroupV1Cpi<'a, 'b> {
...
impl<'a, 'b> AddCollectionsToGroupV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddCollectionsToGroupV1CpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddCollectionsToGroupV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   2. `[signer, optional]` authority
///   3. `[]` system_program
pub struct AddCollectionsToGroupV1CpiBuilder<'a, 'b> {
    instruction: Box<AddCollectionsToGroupV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddCollectionsToGroupV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddCollectionsToGroupV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddCollectionsToGroupV1Cpi {
...
struct AddCollectionsToGroupV1CpiBuilderInstruction<'a, 'b> {
