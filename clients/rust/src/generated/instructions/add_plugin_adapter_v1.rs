...
impl AddPluginAdapterV1 {
    pub fn instruction(
        &self,
        args: AddPluginAdapterV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddPluginAdapterV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct AddPluginAdapterV1InstructionData {
    discriminator: u8,
}

impl AddPluginAdapterV1InstructionData {
    pub fn new() -> Self {
...
pub struct AddPluginAdapterV1InstructionArgs {
    pub init_info: PluginAdapterInitInfo,
}

/// Instruction builder for `AddPluginAdapterV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct AddPluginAdapterV1Builder {
...
impl AddPluginAdapterV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = AddPluginAdapterV1 {
        ...
        let args = AddPluginAdapterV1InstructionArgs {
...
/// `add_plugin_adapter_v1` CPI accounts.
pub struct AddPluginAdapterV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `add_plugin_adapter_v1` CPI instruction.
pub struct AddPluginAdapterV1Cpi<'a, 'b> {
    ...
    pub __args: AddPluginAdapterV1InstructionArgs,
}

impl<'a, 'b> AddPluginAdapterV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AddPluginAdapterV1CpiAccounts<'a, 'b>,
        args: AddPluginAdapterV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddPluginAdapterV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct AddPluginAdapterV1CpiBuilder<'a, 'b> {
    instruction: Box<AddPluginAdapterV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddPluginAdapterV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddPluginAdapterV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AddPluginAdapterV1Cpi {
...
struct AddPluginAdapterV1CpiBuilderInstruction<'a, 'b> {
