...
impl BurnCollection {
    pub fn instruction(
        &self,
        args: BurnCollectionInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = BurnCollectionInstructionData::new().try_to_vec().unwrap();
...
impl BurnCollectionInstructionData {
    fn new() -> Self {
...
pub struct BurnCollectionInstructionArgs {
    pub compression_proof: Option<CompressionProof>,
}

/// Instruction builder for `BurnCollection`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct BurnCollectionBuilder {
...
/// `burn_collection` CPI accounts.
pub struct BurnCollectionCpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `burn_collection` CPI instruction.
pub struct BurnCollectionCpi<'a, 'b> {
    ...
    pub __args: BurnCollectionInstructionArgs,
}

impl<'a, 'b> BurnCollectionCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: BurnCollectionCpiAccounts<'a, 'b>,
        args: BurnCollectionInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `BurnCollection` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` collection
...
pub struct BurnCollectionCpiBuilder<'a, 'b> {
    instruction: Box<BurnCollectionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> BurnCollectionCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(BurnCollectionCpiBuilderInstruction {
            __program: program,
            collection: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = BurnCollectionCpi {
...
struct BurnCollectionCpiBuilderInstruction<'a, 'b> {
