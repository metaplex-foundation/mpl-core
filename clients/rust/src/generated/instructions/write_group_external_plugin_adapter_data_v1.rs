...
/// Accounts.
pub struct WriteGroupExternalPluginAdapterDataV1 {
...
impl WriteGroupExternalPluginAdapterDataV1 {
    pub fn instruction(
        &self,
        args: WriteGroupExternalPluginAdapterDataV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = WriteGroupExternalPluginAdapterDataV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct WriteGroupExternalPluginAdapterDataV1InstructionData {
    discriminator: u8,
}

impl WriteGroupExternalPluginAdapterDataV1InstructionData {
    pub fn new() -> Self {
...
pub struct WriteGroupExternalPluginAdapterDataV1InstructionArgs {
    pub key: ExternalPluginAdapterKey,
    pub data: Option<Vec<u8>>,
}

/// Instruction builder for `WriteGroupExternalPluginAdapterDataV1`.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
#[derive(Default)]
pub struct WriteGroupExternalPluginAdapterDataV1Builder {
...
impl WriteGroupExternalPluginAdapterDataV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the group
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = WriteGroupExternalPluginAdapterDataV1 {
        ...
        let args = WriteGroupExternalPluginAdapterDataV1InstructionArgs {
...
/// `write_group_external_plugin_adapter_data_v1` CPI accounts.
pub struct WriteGroupExternalPluginAdapterDataV1CpiAccounts<'a, 'b> {
    /// The address of the group
...
/// `write_group_external_plugin_adapter_data_v1` CPI instruction.
pub struct WriteGroupExternalPluginAdapterDataV1Cpi<'a, 'b> {
    ...
    pub __args: WriteGroupExternalPluginAdapterDataV1InstructionArgs,
}

impl<'a, 'b> WriteGroupExternalPluginAdapterDataV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WriteGroupExternalPluginAdapterDataV1CpiAccounts<'a, 'b>,
        args: WriteGroupExternalPluginAdapterDataV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WriteGroupExternalPluginAdapterDataV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct WriteGroupExternalPluginAdapterDataV1CpiBuilder<'a, 'b> {
    instruction: Box<WriteGroupExternalPluginAdapterDataV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WriteGroupExternalPluginAdapterDataV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WriteGroupExternalPluginAdapterDataV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WriteGroupExternalPluginAdapterDataV1Cpi {
...
struct WriteGroupExternalPluginAdapterDataV1CpiBuilderInstruction<'a, 'b> {
