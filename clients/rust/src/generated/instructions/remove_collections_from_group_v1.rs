...
impl RemoveCollectionsFromGroupV1 {
    pub fn instruction(
        &self,
        args: RemoveCollectionsFromGroupV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RemoveCollectionsFromGroupV1InstructionData::new()).unwrap();
...
pub struct RemoveCollectionsFromGroupV1InstructionData {
    discriminator: u8,
}

impl RemoveCollectionsFromGroupV1InstructionData {
    pub fn new() -> Self {
...
pub struct RemoveCollectionsFromGroupV1InstructionArgs {
...
#[derive(Default)]
pub struct RemoveCollectionsFromGroupV1Builder {
    group: Option<solana_program::pubkey::Pubkey>,
    payer: Option<solana_program::pubkey::Pubkey>,
    authority: Option<solana_program::pubkey::Pubkey>,
    system_program: Option<solana_program::pubkey::Pubkey>,
    collections: Option<Vec<Pubkey>>,
...
impl RemoveCollectionsFromGroupV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RemoveCollectionsFromGroupV1 {
...
/// `remove_collections_from_group_v1` CPI accounts.
pub struct RemoveCollectionsFromGroupV1CpiAccounts<'a, 'b> {
    /// The address of the group to modify
...
/// `remove_collections_from_group_v1` CPI instruction.
pub struct RemoveCollectionsFromGroupV1Cpi<'a, 'b> {
    ...
    pub __args: RemoveCollectionsFromGroupV1InstructionArgs,
}

impl<'a, 'b> RemoveCollectionsFromGroupV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RemoveCollectionsFromGroupV1CpiAccounts<'a, 'b>,
        args: RemoveCollectionsFromGroupV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveCollectionsFromGroupV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` group
...
///   2. `[signer, optional]` authority
///   3. `[]` system_program
pub struct RemoveCollectionsFromGroupV1CpiBuilder<'a, 'b> {
    instruction: Box<RemoveCollectionsFromGroupV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveCollectionsFromGroupV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveCollectionsFromGroupV1CpiBuilderInstruction {
            __program: program,
            group: None,
            payer: None,
            authority: None,
...
struct RemoveCollectionsFromGroupV1CpiBuilderInstruction<'a, 'b> {
