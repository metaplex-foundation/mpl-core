...
impl RevokeGroupPlugin {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = RevokeGroupPluginInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RevokeGroupPluginInstructionData {
    discriminator: u8,
}

impl RevokeGroupPluginInstructionData {
    pub fn new() -> Self {
        Self { discriminator: 45 }
    }
}

/// Instruction builder for `RevokeGroupPlugin`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   2. `[writable]` plugin
#[derive(Default)]
pub struct RevokeGroupPluginBuilder {
...
impl RevokeGroupPluginBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RevokeGroupPlugin {
...
/// `revoke_group_plugin` CPI accounts.
pub struct RevokeGroupPluginCpiAccounts<'a, 'b> {
    /// The group update authority or delegated authority
...
/// `revoke_group_plugin` CPI instruction.
pub struct RevokeGroupPluginCpi<'a, 'b> {
...
impl<'a, 'b> RevokeGroupPluginCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RevokeGroupPluginCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RevokeGroupPlugin` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
///   1. `[]` group
///   2. `[writable]` plugin
pub struct RevokeGroupPluginCpiBuilder<'a, 'b> {
    instruction: Box<RevokeGroupPluginCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RevokeGroupPluginCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RevokeGroupPluginCpiBuilderInstruction {
            __program: program,
            authority: None,
            group: None,
            plugin: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RevokeGroupPluginCpi {
...
struct RevokeGroupPluginCpiBuilderInstruction<'a, 'b> {
