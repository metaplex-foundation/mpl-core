...
/// Accounts.
pub struct ClearExternalPluginDataV1 {
...
impl ClearExternalPluginDataV1 {
    pub fn instruction(
        &self,
        args: ClearExternalPluginDataV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClearExternalPluginDataV1InstructionData::new()
            .try_to_vec()
            .unwrap();
...
struct ClearExternalPluginDataV1InstructionData {
    discriminator: u8,
}

impl ClearExternalPluginDataV1InstructionData {
    fn new() -> Self {
...
pub struct ClearExternalPluginDataV1InstructionArgs {
    pub key: ExternalPluginKey,
}

/// Instruction builder for `ClearExternalPluginDataV1`.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
#[derive(Default)]
pub struct ClearExternalPluginDataV1Builder {
...
impl ClearExternalPluginDataV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The address of the asset
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = ClearExternalPluginDataV1 {
        ...
        let args = ClearExternalPluginDataV1InstructionArgs {
...
/// `clear_external_plugin_data_v1` CPI accounts.
pub struct ClearExternalPluginDataV1CpiAccounts<'a, 'b> {
    /// The address of the asset
...
/// `clear_external_plugin_data_v1` CPI instruction.
pub struct ClearExternalPluginDataV1Cpi<'a, 'b> {
    ...
    pub __args: ClearExternalPluginDataV1InstructionArgs,
}

impl<'a, 'b> ClearExternalPluginDataV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ClearExternalPluginDataV1CpiAccounts<'a, 'b>,
        args: ClearExternalPluginDataV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ClearExternalPluginDataV1` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` asset
...
///   4. `[]` system_program
///   5. `[optional]` log_wrapper
pub struct ClearExternalPluginDataV1CpiBuilder<'a, 'b> {
    instruction: Box<ClearExternalPluginDataV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ClearExternalPluginDataV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ClearExternalPluginDataV1CpiBuilderInstruction {
            __program: program,
            asset: None,
            collection: None,
            payer: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = ClearExternalPluginDataV1Cpi {
...
struct ClearExternalPluginDataV1CpiBuilderInstruction<'a, 'b> {
