...
impl RemoveAssetsFromGroup {
    pub fn instruction(
        &self,
        args: RemoveAssetsFromGroupInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = RemoveAssetsFromGroupInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RemoveAssetsFromGroupInstructionData {
    discriminator: u8,
}

impl RemoveAssetsFromGroupInstructionData {
    pub fn new() -> Self {
...
pub struct RemoveAssetsFromGroupInstructionArgs {
    pub asset_indices: Vec<u8>,
    pub authority_indices: Vec<u8>,
}

/// Instruction builder for `RemoveAssetsFromGroup`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
///   1. `[writable]` group
#[derive(Default)]
pub struct RemoveAssetsFromGroupBuilder {
...
impl RemoveAssetsFromGroupBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// The group update authority or delegated authority
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = RemoveAssetsFromGroup {
            authority: self.authority.expect("authority is not set"),
            group: self.group.expect("group is not set"),
        };
        let args = RemoveAssetsFromGroupInstructionArgs {
            asset_indices: self
                .asset_indices
                .clone()
...
/// `remove_assets_from_group` CPI accounts.
pub struct RemoveAssetsFromGroupCpiAccounts<'a, 'b> {
    /// The group update authority or delegated authority
...
/// `remove_assets_from_group` CPI instruction.
pub struct RemoveAssetsFromGroupCpi<'a, 'b> {
    ...
    pub __args: RemoveAssetsFromGroupInstructionArgs,
}

impl<'a, 'b> RemoveAssetsFromGroupCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: RemoveAssetsFromGroupCpiAccounts<'a, 'b>,
        args: RemoveAssetsFromGroupInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RemoveAssetsFromGroup` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
///   1. `[writable]` group
pub struct RemoveAssetsFromGroupCpiBuilder<'a, 'b> {
    instruction: Box<RemoveAssetsFromGroupCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveAssetsFromGroupCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveAssetsFromGroupCpiBuilderInstruction {
            __program: program,
            authority: None,
            group: None,
            asset_indices: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = RemoveAssetsFromGroupCpi {
...
struct RemoveAssetsFromGroupCpiBuilderInstruction<'a, 'b> {
