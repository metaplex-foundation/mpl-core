...
pub enum MplCoreError {
    ...
    /// 57 (0x39) - Plugin is not allowed to be added to an Asset
...
impl TryFrom<u32> for MplCoreError {
    ...
    fn try_from(error: u32) -> Result<Self, Self::Error> {
        match error {
            ...
            57 => Ok(MplCoreError::PluginNotAllowedOnAsset),
...
impl ToStr for MplCoreError {
    fn to_str(&self) -> &'static str {
        match self {
            ...
            MplCoreError::PluginNotAllowedOnAsset => {
                "Plugin is not allowed to be added to an Asset"
            }
        }
    }
}
