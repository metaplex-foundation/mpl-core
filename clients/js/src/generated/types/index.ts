...
export * from './adapterCheckResult';
export * from './adapterRegistryRecord';
export * from './adapterValidationResult';
...
export * from './basePluginAdapterInitInfo';
export * from './basePluginAdapterKey';
export * from './basePluginAdapterUpdateInfo';
...
export * from './pluginAdapterSchema';
export * from './pluginAdapterType';
