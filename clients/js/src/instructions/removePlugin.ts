...
import { removePluginV1, removeExternalPluginV1, PluginType } from "../generated";
import { isExternalPluginType } from "../plugins";
import { ExternalPluginKey, externalPluginKeyToBase } from "../plugins/externalPluginKey";

export type RemovePluginArgs = Omit<Parameters<typeof removePluginV1>[1], 'pluginType'> & {
  plugin: {
