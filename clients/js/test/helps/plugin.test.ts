...
test('it can detect correct authorities on many types and plugins', async (t) => {
  ...
  const checkUpdateAuth = checkPluginAuthorities({
    asset,
    pluginTypes: [PluginType.FreezeDelegate, PluginType.TransferDelegate, PluginType.UpdateDelegate, PluginType.BurnDelegate, PluginType.PermanentFreezeDelegate],
